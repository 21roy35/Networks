...
class ClaudeAssistant:
    ...
    def choose_complaint_category(self, incident: str, options: list[str],
        ...
        schema = {
            ...
            "properties": {
                "category": {
                    ...
                    "enum": allowed,
                    "description": (
                        "The single exact portal option that best matches "
        ...
        prompt = (
            ...
            "Return only the exact category required by the schema; explanatory prose "
            "is intentionally omitted because this call is only a dropdown selector.\n\n"
        ...
        for _attempt in range(2):
            result = self._structured(prompt, schema, max_tokens=120)
